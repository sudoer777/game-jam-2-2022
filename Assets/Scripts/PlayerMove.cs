        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            if (shotcooldown <= 0) {
                if (Player.Instance.gun == 0) {
                    float playerProjectileSpeed = 24f;
                    ...
                    float playerProjectileSpeed = 18f;
                    float angle = ang-2/5;
                    ...
                    for (float i = -2; i < 2.1f; i += 1) {
                        float playerProjectileSpeed = 18f+4*i;
                        Vector3 direction = new Vector3(Mathf.Cos(ang), Mathf.Sin(ang), 0);
                    ...
                    for (float i = -1; i < 2.1f; i += 1) {
                        for (float j = -1; j < 1.1f; j += 1) {
                            float playerProjectileSpeed = 20f+4*i;
                    ...
                    float playerProjectileSpeed = 22f;
                    Vector3 direction = new Vector3(Mathf.Cos(ang), Mathf.Sin(ang), 0);
